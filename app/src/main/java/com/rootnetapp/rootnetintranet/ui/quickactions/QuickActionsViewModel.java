...
public class QuickActionsViewModel extends ViewModel {
    ...
    private static final String TAG = "QuickActionsVM";

    private QuickActionsRepository mRepository;
    ...
    protected QuickActionsViewModel(QuickActionsRepository quickActionsRepository) {
        this.mRepository = quickActionsRepository;
